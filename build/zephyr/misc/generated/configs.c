...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DH_ACCEL_RANGE_8G, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_CONFSTR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_RWLOCK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_PRIORITY_SCHEDULING, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_PUTMSG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_SYSCONF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_PAGE_SIZE_BITS, 12);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_SYSCONF_IMPL_MACRO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_SYSLOG, 1);
